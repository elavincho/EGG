...
public class Hotel4 extends Hotel {
    ...
    public Hotel4(String gimnacio, String nombreRestaurante, int capacidadRestaurante, int cantHabitaciones, int nroCamas, int cantPisos, int precioHabitacion, String nombre, String direccion, String localidad, String gerente) {
    ...
    public String toString() {
        return "Hotel4{" + "gimnacio=" + gimnacio + ", nombreRestaurante=" + nombreRestaurante + ", capacidadRestaurante=" + capacidadRestaurante + '}';
    }
