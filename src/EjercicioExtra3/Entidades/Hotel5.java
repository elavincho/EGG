...
public class Hotel5 extends Hotel4 {
    ...
    public Hotel5(Integer cantSalonesConferencia, Integer cantSuites, Integer cantLimosinas, String gimnacio, String nombreRestaurante, int capacidadRestaurante, int cantHabitaciones, int nroCamas, int cantPisos, int precioHabitacion, String nombre, String direccion, String localidad, String gerente) {
        super(gimnacio, nombreRestaurante, capacidadRestaurante, cantHabitaciones, nroCamas, cantPisos, precioHabitacion, nombre, direccion, localidad, gerente);
