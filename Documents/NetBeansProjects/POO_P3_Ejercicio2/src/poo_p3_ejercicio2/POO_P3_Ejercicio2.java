 ...
 * @author elavincho
 */
public class POO_P3_Ejercicio2 {
...
valor absoluto del número.*/
   ...
   ParDeNumeros pDeN = new ParDeNumeros();
   //Llamamos a la funcion mostrar valores
   servicio.mostrarValores();
   //Llamamos a la funcion devolver mayor
   servicio.devolverMayor(pDeN);
   //Llamamos a la funcion calcular potencia
   servicio.calcularPotencia(pDeN);
   //Llamamos a la funcion calcular raiz
   servicio.calcularRaiz(pDeN);
