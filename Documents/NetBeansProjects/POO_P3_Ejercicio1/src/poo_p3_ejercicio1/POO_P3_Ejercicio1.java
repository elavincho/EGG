 ...
 * @author elavincho
 */
public class POO_P3_Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        // Llamamos a la funcion ingresar frase
        servicio.ingresarFrase();
        System.out.println("");
        //Llamamos a la funcion mostrar vocales
        servicio.mostrarVocales();
        System.out.println("");
        //Llamamos a la funcion invertir frase
        servicio.invertirFrase();
        System.out.println("");
        // Llamamos a la funcion veces repetido
        servicio.vecesRepetido();
        System.out.println("");
        //Llamamos a la funcion comparar longitud
        servicio.compararLongitud();
        System.out.println("");
        //Llamamos a la funcion unir frases
        servicio.unirFrases();
        System.out.println("");
        // Llamamos a la funcion reemplazar
        System.out.println("La frase con la letra A Cambia es: en el main");
        System.out.println(servicio.reemplazar());
        System.out.println("");
        //Llamamos a la funcion contiene
        servicio.contieneLetra();
