 ...
 */
package poo_p2_ejercicioextra1;
 ...
 * @author elavincho
 */
public class POO_P2_EjercicioExtra1 {
    ...
    public static void main(String[] args) {
        ...
        // Llamaos a la clase raices
        
        Raices rc = servicio.crearValores();
        
        //Llamamos a los metodos
        servicio.Discriminante();
        //servicio.obtenerRaices(true);
        //servicio.obtenerRaiz(true);
        servicio.Calcular(true, true);
